...
def se_pueden_reducir(matriz_de_canal: Matriz[float], columna1: int, columna2: int) -> bool:
    """
    Determina si dos canales representados por las columnas `columna1` y `columna2` de la matriz de canal
    ...
    """
    columna1 = matriz_de_canal.getColumna(columna1)
    columna2 = matriz_de_canal.getColumna(columna2)
