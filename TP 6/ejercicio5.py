...
if __name__ == "__main__":
    ...
    print("---Canal 1---")
    print("I(A,B) = ", get_informacion_mutua(A_1, canal_1))
    post_producto = mf.identidad(canal_1.cantidadColumnas - 1)
    post_producto.insertar_fila(1, [1, 0, 0])
    canal_1 *= post_producto
    print("Canal modificado:\n", canal_1)
    print("I(A,B) = ", get_informacion_mutua(A_1, canal_1))
    if es_canal_determinante(canal_1):
